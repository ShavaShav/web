...
const FilterContainer = styled.div<{ showFilters: boolean }>`
...
const Container = styled.aside<{ showFilters: boolean }>`
...
const CategoryFilters: React.FC<CategoryFiltersProps> = (props) => {
  ...
  return (
    <Container showFilters={showFilters}>
      ...
      <FilterContainer className={className} showFilters={showFilters}>
        <h4>Platform</h4>
        <CheckboxGroup>
          <StyledCheckbox
            label="Mobile"
            value={showMobile}
            icon={faMobileAlt}
            onChange={setShowMobile}
          />
          <StyledCheckbox
            label="Desktop"
            value={showDesktop}
            icon={faDesktop}
            onChange={setShowDesktop}
          />
        </CheckboxGroup>
        <h4>Languages</h4>
