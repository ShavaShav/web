...
export type Skill = 'robotics' | 'devops' | 'tdd' | 'bdd' | 'algorithms' | 'networking' | 'rest' | 'frontend' | 'backend' | 'concurrent' | 'agile' | 'testing' | 'qa' | 'teaching' | 'vpn'
...
export type Tool =  'selenium' | 'docker' | 'cucumber' | 'gradle' | 'birt' | 'tomcat' | 'jenkins' | 'node' | 'aws' | 'gimp' | 'heroku' | 'jira' | 'nginx' | 'npm' | 'oracle' | 'slack' | 'swagger' 
export type Framework = 'android' | 'ios' | 'liferay' | 'odoo' | 'firebase' | 'qt' | 'javafx' | 'grafana'
export type Library =  'jquery' | 'react' | 'reactnative' | 'express' | 'jest' | 'redux' | 'sequelize' | 'pytest' | 'styledcomponents'
